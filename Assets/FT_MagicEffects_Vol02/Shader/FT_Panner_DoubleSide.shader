...
////// Emissive:
                ...
                float3 emissive = (lerp( 1.0, pow((1.0 - pow(1.0-max(0,dot(normalDirection, viewDirection)),5.0)),_Fresnel_Strength), _Use_Fresnel )*(lerp(float3(node_1338,node_1338,node_1338),_Texture_var.rgb,_Texture_var.a)*i.vertexColor.rgb*_Color.rgb*_Emission*i.vertexColor.a)*lerp( 1.0, saturate((sceneZ-partZ)/_SoftParticle_Value), _Use_SoftPaticle ));
