...
Shader "FT/Emission_DoubleSide" {
    Properties {
        _Color ("Color", Color) = (1,0.3529412,0,1)
...
////// Emissive:
                ...
                float3 emissive = ((lerp(float3(node_9007,node_9007,node_9007),_Texture_var.rgb,_Texture_var.a)*_Color.rgb*_Emission)*i.vertexColor.rgb*i.vertexColor.a*lerp( 1.0, saturate((sceneZ-partZ)/_SoftParticle_Value), _Use_SoftPaticle ));
