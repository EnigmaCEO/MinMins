...
extern "C" {
	...
	void Tapjoy_SubjectToGDPR(bool enabled)
	{
		[Tapjoy subjectToGDPR:enabled];
	}

	void Tapjoy_SetUserConsent(const char* consent)
	{
		[Tapjoy setUserConsent: tjCreateNSString(consent)];
	}

	void Tapjoy_BelowConsentAge(bool belowConsentAge)
	{
		[Tapjoy belowConsentAge:belowConsentAge];
	}
