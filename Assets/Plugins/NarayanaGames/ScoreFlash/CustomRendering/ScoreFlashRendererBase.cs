...
namespace NarayanaGames.ScoreFlashComponent {
    ...
    public abstract class ScoreFlashRendererBase : MonoBehaviour {
        ...
        ///     anchors or panels. NeverAssignParent will override this,
        ///     so when this is true, and NeverAssignParent is also true,
        ///     nothing will be assigned (so this will be ignored).
        /// </summary>
        public abstract bool RequiresCustomParent { get; }

        /// <summary>
        ///     Certain UI renders, like Unity UI and TextMesh Pro, may
        ///     allocate significant amounts of memory when their parent
        ///     is changed. Set this to true to disable assigning of
        ///     parents which may save some memory.
        /// </summary>
        public abstract bool NeverAssignParent { get; }
        ...
        public virtual ScoreFlashRendererBase CreateInstance(Transform parent) {
            ScoreFlashRendererBase result = Instantiate(this);
