    ...
    public class ScoreMessage : IComparable
    {
        ...
        public string Text {
            get {
                ...
                return string.IsNullOrEmpty(appendToText)
                    ? text : string.Format("{0} {1}", text, appendToText);
            }
            set { text = value; }
        }
        ...
        public StringBuilder TextBuilder {
            get { return textBuilder; }
            set {
                textBuilder = value;
                //if (textBuilder != null) {
                //    text = (string)textBuilder.GetType().GetField(
                //                        "m_StringValue", BindingFlags.NonPublic | BindingFlags.Instance)
                //                        .GetValue(textBuilder);
                //}
            }
        }
        ...
        public void UpdateMessage(object message) {
            ...
            } else if (message is StringBuilder) {
                this.TextBuilder = (StringBuilder)message;
        ...
        /// </summary>
        public ScoreFlashRendererBase scoreFlashRenderer = null;
        /// <summary>
