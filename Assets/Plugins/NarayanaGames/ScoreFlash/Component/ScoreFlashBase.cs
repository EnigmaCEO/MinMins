...
namespace NarayanaGames.ScoreFlashComponent {
    ...
    public abstract class ScoreFlashBase : MonoBehaviour, IHasTooltips, IHasVisualDesigner {
        ...
        /// <summary>
        ///     The current version of ScoreFlash: 5.0.1
        /// </summary>
        public const string VERSION = "5.0.1";
        /// <summary>
        ///     The build date of this version: 2018-05-21
        /// </summary>
        public const string BUILT = "2018-05-21";
        ...
        public void OnSceneViewGUI(SceneView sceneView) {
            try {
                ...
                //Debug.LogWarning("De-Registered ScoreFlash from Scene View GUI rendering!");
            }
        }
